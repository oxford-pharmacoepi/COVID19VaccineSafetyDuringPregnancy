...
survivalTidy |>
  ...
  ggh4x::facetted_pos_scales(
    y  = list(
      outcome == "Ectopic pregnancy" ~ scale_y_continuous(limits = c(0,0.04), oob = scales::rescale_none),
...
pPregnancy <- survivalTidyAge |>
  ...
  #   ),
    y  = list(
      outcome == "Ectopic pregnancy" ~ scale_y_continuous(limits = c(0,0.04), oob = scales::rescale_none),
      outcome == "Antepartum haemorrhage" ~ scale_y_continuous(limits = c(0,0.1), oob = scales::rescale_none),
