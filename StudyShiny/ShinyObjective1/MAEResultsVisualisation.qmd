...
outcomeCode <- c("miscarriage", "stillbirth", "ectopic_pregnancy", "antepartum_haemorrhage",  "gestational_diabetes", "preeclampsia", "eclampsia", "hellp", "preterm_labour", "dysfunctional_labour", "postpartum_endometritis", "postpartum_haemorrhage", "maternal_death")
outcomeClean <- c("Miscarriage", "Stillbirth", "Ectopic pregnancy", "Antepartum haemorrhage",  "Gestational diabetes", "Pre-eclampsia", "Eclampsia", "HELLP syndrome", "Preterm labour", "Dysfunctional labour", "Postpartum endometritis", "Postpartum haemorrhage", "Maternal death")
